...
public interface PluginIcons {
    ...
    Icon fastRequest = IconLoader.getIcon("/wellRequest.svg", PluginIcons.class);
    Icon fastRequest_editor = IconLoader.getIcon("/icon/wellRequest_editor.svg", PluginIcons.class);
    Icon fastRequest_toolwindow = IconLoader.getIcon("/icon/wellRequest_toolwindow.svg", PluginIcons.class);
