...
import com.liuxz.request.model.CollectionConfiguration;
import com.liuxz.request.view.WellRequestCollectionToolWindow;
import com.liuxz.request.view.WellRequestToolWindow;
import com.liuxz.request.view.AllApisNavToolWindow;
import org.jetbrains.annotations.NotNull;

import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

public class WellRequestToolWindowFactory implements ToolWindowFactory, DumbAware {

    private WellRequestToolWindow window;

    private WellRequestCollectionToolWindow collectionToolWindow;

    private AllApisNavToolWindow allApisNavToolWindow;

    private final Map<String, WellRequestToolWindow> windowMap = new ConcurrentHashMap<>();
    private final Map<String, WellRequestCollectionToolWindow> apiWindowMap = new ConcurrentHashMap<>();
    private final Map<String, AllApisNavToolWindow> allApisNavToolWindowMap = new ConcurrentHashMap<>();

    @Override
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        window = new WellRequestToolWindow(toolWindow, project);
        collectionToolWindow = new WellRequestCollectionToolWindow(project, toolWindow);
