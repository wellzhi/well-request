...
import com.liuxz.request.model.ParamKeyValue;
import com.liuxz.request.model.ParamNameType;
import com.liuxz.request.util.KV;
import com.liuxz.request.util.StringUtils;
import com.liuxz.request.util.TypeUtil;
...
public class PathValueParamParse extends AbstractParamParse {
    @Override
    public LinkedHashMap<String, Object> parseParam(WellRequestConfiguration config, List<ParamNameType> paramNameTypeList) {
