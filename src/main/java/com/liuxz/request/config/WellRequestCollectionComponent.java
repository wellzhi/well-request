...
import com.liuxz.request.model.ParamGroupCollection;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

import java.util.Objects;

@State(name = "wellRequestCollection", storages = {@Storage("wellRequestCollection.xml")})
public class WellRequestCollectionComponent implements PersistentStateComponent<CollectionConfiguration> {
    ...
    public static WellRequestCollectionComponent getInstance(Project project) {
        return project.getService(WellRequestCollectionComponent.class);
    }
}
