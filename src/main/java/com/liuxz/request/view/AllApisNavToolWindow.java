...
import com.liuxz.request.action.CheckBoxFilterAction;
import com.liuxz.request.config.Constant;
import com.liuxz.request.configurable.WellRequestSearchEverywhereConfiguration;
import com.liuxz.request.model.ApiService;
import com.liuxz.request.model.MethodType;
import com.liuxz.request.view.component.tree.*;
...
//        renderData(myProject);
    ...
    public static PersistentSearchEverywhereContributorFilter<String> createMethodTypeFilter() {
        ...
        return new PersistentSearchEverywhereContributorFilter<>(
                methodNameList,
                WellRequestSearchEverywhereConfiguration.getInstance(),
    ...
    private void initActionBar() {
        ...
        moduleFilter = new CheckBoxFilterAction.Filter<>(moduleList, module -> module, module -> null, WellRequestSearchEverywhereConfiguration.getInstance());
        group.add(new CheckBoxFilterAction<>("Filter Module", "Filter module", AllIcons.Actions.GroupByModule, moduleFilter, this::refresh));


        List<String> methodNameList = Constant.METHOD_TYPE_LIST.stream().map(MethodType::getName).collect(Collectors.toList());
        Map<String, Icon> iconMap = Constant.METHOD_TYPE_LIST.stream().collect(Collectors.toMap(MethodType::getName, MethodType::getIcon));
        methodTypeFilter = new CheckBoxFilterAction.Filter<>(methodNameList, methodName -> methodName, iconMap::get, WellRequestSearchEverywhereConfiguration.getInstance());
