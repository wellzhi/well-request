...
import com.liuxz.request.model.HostGroup;
import com.liuxz.request.model.NameGroup;
import com.liuxz.request.view.inner.EnvAddView;
import com.liuxz.request.view.inner.GlobalHeaderAddView;
...
public class CommonConfigView extends AbstractConfigurableView {
    ...
    public CommonConfigView(WellRequestConfiguration config) {
        super(config);
    }
     ...
     * @date 2021/05/21
     */
    private void renderingProjectPanel(WellRequestConfiguration configOld) {
     ...
     * @date 2021/05/21
     */
    private void renderingEnvPanel(WellRequestConfiguration configOld) {
...
//                config.setEnableEnv(null);
    ...
    private void renderingGlobalRequestHeaderPanel(WellRequestConfiguration configOld){
