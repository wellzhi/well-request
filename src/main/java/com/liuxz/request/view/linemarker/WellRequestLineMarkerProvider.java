...
package com.liuxz.request.view.linemarker;
...
public class WellRequestLineMarkerProvider implements LineMarkerProvider {
        ...
        if (element instanceof PsiIdentifier && element.getParent() instanceof PsiMethod) {
            ...
            lineMarkerInfo = new LineMarkerInfo<>(element, element.getTextRange(), PluginIcons.fastRequest_editor,
                    ...
                    (e, elt) -> {
                        ...
                        //打开工具窗口
                        ToolWindow fastRequestToolWindow = ToolWindowManager.getInstance(project).getToolWindow("Well Request");
                    ...
                    GutterIconRenderer.Alignment.LEFT, () -> "wellRequest");
