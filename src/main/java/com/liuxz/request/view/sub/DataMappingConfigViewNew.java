...
package com.liuxz.request.view.sub;
...
import com.liuxz.request.util.MyResourceBundleUtil;
import com.liuxz.request.view.AbstractConfigurableView;
import com.liuxz.request.view.inner.DataMappingAddView;
import com.liuxz.request.view.inner.IgnoreDataMappingAddView;
...
public class DataMappingConfigViewNew extends AbstractConfigurableView {
    ...
    private WellRequestConfiguration configOld;
    ...
    public DataMappingConfigViewNew(WellRequestConfiguration config) {
        super(config);
        randomStringTextField = new JTextField();
        randomStringDelimiterTextField = new JTextField();
        WellRequestConfiguration configOld = JSONObject.parseObject(JSONObject.toJSONString(config), WellRequestConfiguration.class);
    ...
    public WellRequestConfiguration getConfigOld() {
        return configOld;
    }

    public void setConfigOld(WellRequestConfiguration configOld) {
