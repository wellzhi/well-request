...
import com.liuxz.request.idea.SearchEverywherePsiRenderer;
...
public class WellRequestGotoContributor extends AbstractGotoSEContributor  {
    private Project myProject;
    private RequestMappingModel requestMappingModel;

    protected WellRequestGotoContributor(@NotNull AnActionEvent event) {
        super(event);
        myProject = event.getProject();
        requestMappingModel = new RequestMappingModel(myProject, ExtensionPointName.<ChooseByNameContributor>create("com.liuxz.request.WellRequest.requestMappingContributor").getExtensionList());
    }
    ...
    static class Factory implements SearchEverywhereContributorFactory<Object>{
        ...
        public @NotNull SearchEverywhereContributor<Object> createContributor(@NotNull AnActionEvent initEvent) {
            return new WellRequestGotoContributor(initEvent);
        }
